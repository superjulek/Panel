...
PinMaster::PinMaster()
    : AI_expander(&hi2c2, MAX11616_ADDRESS), DI_DO_expanders{MCP23017{&hi2c1, MCP_ADDRESS_1}, MCP23017{&hi2c1, MCP_ADDRESS_2},
                                                             MCP23017{&hi2c1, MCP_ADDRESS_3}, MCP23017{&hi2c1, MCP_ADDRESS_4}}
{
    ...
    external_DO_pins[LIGHT9] = (external_pin){.exp_num = 1, .pin = MCP23017::MCP23017_pin::GPA0};
    ...
    external_DO_pins[LIGHT25] = (external_pin){.exp_num = 2, .pin = MCP23017::MCP23017_pin::GPA0};
