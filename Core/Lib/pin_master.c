...
pin_master_t *pin_master_create()
{
    ...
    *this = (private_pin_master_t){
    ...
    this->internal_DI_pins[SWITCH1] = (internal_pin_t){.port = GPIOA, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH2] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_10};
    this->internal_DI_pins[SWITCH3] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_11};
    this->internal_DI_pins[SWITCH4] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_12};
    this->internal_DI_pins[SWITCH5] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_0};
    this->internal_DI_pins[SWITCH6] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_1};
    this->internal_DI_pins[SWITCH7] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH8] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH9] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_4};
    this->internal_DI_pins[SWITCH10] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_5};
    this->internal_DI_pins[SWITCH11] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_6};
    this->internal_DI_pins[SWITCH12] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_7};
    this->internal_DI_pins[SWITCH13] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_9};
    this->internal_DI_pins[SWITCH14] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_10};
    this->internal_DI_pins[SWITCH15] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_11};
    this->internal_DI_pins[SWITCH16] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_12};
    this->internal_DI_pins[SWITCH17] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_13};
    this->internal_DI_pins[SWITCH18] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_14};
    this->internal_DI_pins[SWITCH19] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH20] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH21] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_4};
    this->internal_DI_pins[SWITCH22] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_5};
    this->internal_DI_pins[SWITCH23] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_6};
    this->internal_DI_pins[SWITCH24] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_7};
    this->internal_DI_pins[SWITCH25] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_0};
    this->internal_DI_pins[SWITCH26] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_1};
    this->internal_DI_pins[SWITCH27] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH28] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH29] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_4};
    this->internal_DI_pins[SWITCH30] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_5};
    this->internal_DI_pins[SWITCH31] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_6};
    this->internal_DI_pins[SWITCH32] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_13};
    this->internal_DI_pins[SWITCH33] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_14};
    this->internal_DI_pins[SWITCH34] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH35] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_0};
    this->internal_DI_pins[SWITCH36] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_1};
    this->internal_DI_pins[SWITCH37] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH38] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH39] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_4};
    this->internal_DI_pins[SWITCH40] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_5};

    this->internal_DI_pins[SWITCH_12v1] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_6};
    this->internal_DI_pins[SWITCH_12v2] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_7};
    this->internal_DI_pins[SWITCH_12v3] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_8};
    this->internal_DI_pins[SWITCH_12v4] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_9};
    this->internal_DI_pins[SWITCH_12v5] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_10};
    this->internal_DI_pins[SWITCH_12v6] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_0};
    this->internal_DI_pins[SWITCH_12v7] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_1};
    this->internal_DI_pins[SWITCH_12v8] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH_12v9] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH_12v10] = (internal_pin_t){.port = GPIOA, .pin = GPIO_PIN_0};

    this->internal_DI_pins[SWITCH_INSTA1] = (internal_pin_t){.port = GPIOA, .pin = GPIO_PIN_1};
    this->internal_DI_pins[SWITCH_INSTA2] = (internal_pin_t){.port = GPIOA, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH_INSTA3] = (internal_pin_t){.port = GPIOA, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH_INSTA4] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH_INSTA5] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_11};

    this->internal_DI_pins[SWITCH_3_A_1] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_12};
    this->internal_DI_pins[SWITCH_3_B_1] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_13};
    this->internal_DI_pins[SWITCH_3_A_2] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_14};
    this->internal_DI_pins[SWITCH_3_B_2] = (internal_pin_t){.port = GPIOF, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH_3_A_3] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_0};
    this->internal_DI_pins[SWITCH_3_B_3] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_1};
    this->internal_DI_pins[SWITCH_3_A_4] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_7};
    this->internal_DI_pins[SWITCH_3_B_4] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_8};
    this->internal_DI_pins[SWITCH_3_A_5] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_9};
    this->internal_DI_pins[SWITCH_3_B_5] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_10};

    this->internal_DI_pins[SWITCH_4_A_1] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_11};
    this->internal_DI_pins[SWITCH_4_B_1] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_12};
    this->internal_DI_pins[SWITCH_4_C_1] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_13};
    this->internal_DI_pins[SWITCH_4_D_1] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_14};
    this->internal_DI_pins[SWITCH_4_A_2] = (internal_pin_t){.port = GPIOE, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH_4_B_2] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_12};
    this->internal_DI_pins[SWITCH_4_C_2] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_13};
    this->internal_DI_pins[SWITCH_4_D_2] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_14};
    this->internal_DI_pins[SWITCH_4_A_3] = (internal_pin_t){.port = GPIOB, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH_4_B_3] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_14};
    this->internal_DI_pins[SWITCH_4_C_3] = (internal_pin_t){.port = GPIOD, .pin = GPIO_PIN_15};
    this->internal_DI_pins[SWITCH_4_D_3] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_2};
    this->internal_DI_pins[SWITCH_4_A_4] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_3};
    this->internal_DI_pins[SWITCH_4_B_4] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_4};
    this->internal_DI_pins[SWITCH_4_C_4] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_5};
    this->internal_DI_pins[SWITCH_4_D_4] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_6};
    this->internal_DI_pins[SWITCH_4_A_5] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_7};
    this->internal_DI_pins[SWITCH_4_B_5] = (internal_pin_t){.port = GPIOG, .pin = GPIO_PIN_8};
    this->internal_DI_pins[SWITCH_4_C_5] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_8};
    this->internal_DI_pins[SWITCH_4_D_5] = (internal_pin_t){.port = GPIOC, .pin = GPIO_PIN_9};
